  ...
  return (
    <div className="min-h-screen bg-[#02040a] text-white font-sans antialiased overflow-x-hidden relative">
      ...
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-6 h-16 border-b border-white/5 bg-[#02040a]/80 backdrop-blur-md header-safe"
      >
        <Link
          to="/"
